...
const Header = () => {
    ...
    return (
        ...
        >
            ...
            >
                unlieash your creativity with ai . turn your imagination into visuals art in seconds - just type , and watch the magic happen
            </motion.p>
            <motion.button onClick={onClickHandler} className='sm:text-lg  text-white bg-black w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full'
                ...
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ default: { duration: 1 }, opacity: { delay: 0.8, duration: 0.8 } }}
            >
                Generate Images
